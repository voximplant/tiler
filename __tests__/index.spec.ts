...
suite('Support functions', () => {
  ...
  suite('generateMargins function', () => {
    ...
    Object.entries(testMock).forEach(row => test(`${row[0]}: input ${arrFormat(row[1].data)} output ${arrFormat(row[1].result)}`, () => {
      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      //@ts-ignore
  ...
  suite('calculateSocketLinearSize function', () => {
    ...
    testMock.forEach(row => {
      test(`calculation ${row.slots} slots for ${row.size} with margin ${row.margin} = ${arrFormat(row.expectation)}`, () => {
...
suite('Layout declaration format test', () => {
  test('Positive test', () => {
    const testFx = () => {
      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      //@ts-ignore
      createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:[{fromCount:1,toCount:1,colCount:1,rowCount:1}]},]});
    }
  ...
  suite('Areas validators', () => {
    test('If no area set must throw exception', () => {
      ...
      expect(testFx).to.throw(TypeError, 'layoutOptions.area have no items. At least one is required.');
    })
    ...
    suite('Validate area content',()=>{
      test('Test index in exception',()=>{
        const testFx1 = () => {
          ...
          //@ts-ignore
          createTiler({width: 1920, height: 1080, areas: [
              {priority:0,width:1920,height:1080,top:0,left:0,grid:[{rowCount:1,colCount:1,toCount:1,fromCount:1}]},
              // eslint-disable-next-line @typescript-eslint/ban-ts-comment
              //@ts-ignore
              {priority:'a'},
            ]});
        ...
        const testFx2 = () => {
          ...
          createTiler({width: 1920, height: 1080, areas: [
              {priority:0,width:1920,height:1080,top:0,left:0,grid:[{rowCount:1,colCount:1,toCount:1,fromCount:1}]},
              {priority:1,width:1920,height:1080,top:0,left:0,grid:[{rowCount:1,colCount:1,toCount:1,fromCount:1}]},
              // eslint-disable-next-line @typescript-eslint/ban-ts-comment
              //@ts-ignore
              {priority:'a'},
              {priority:2,width:1920,height:1080,top:0,left:0,grid:[{rowCount:1,colCount:1,toCount:1,fromCount:1}]},
            ]});
        }
      ...
      suite('Width validators',()=>{
        test('Width === 0 must throw exception', () => {
          ...
          expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].width is not a positive number');
        })
        test('Width < 0 must throw exception', () => {
          const testFx = () => {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      ...
      suite('Height validators',()=>{
        test('Height === 0 must throw exception', () => {
          const testFx = () => {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            //@ts-ignore
            createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:0},]});
          }
          expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].height is not a positive number');
        })
        test('Height < 0 must throw exception', () => {
          const testFx = () => {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            //@ts-ignore
            createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:-2},]});
          }
          expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].height is not a positive number');
        })
        test('NaN height must throw exception', () => {
          const testFx = () => {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            //@ts-ignore
            createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:'a'},]});
          }
          expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].height is not a positive number');
        })
      })
      suite('Top validators',()=>{
        test('NaN top must throw exception', () => {
          const testFx = () => {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            //@ts-ignore
            createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:'a'},]});
          }
        ...
        test('Empty top must throw exception', () => {
          const testFx = () => {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            //@ts-ignore
            createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080},]});
          }
          expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].top is not a number');
        })
      })
      suite('Left validators',()=>{
        test('NaN left must throw exception', () => {
          const testFx = () => {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            //@ts-ignore
            createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:'a'},]});
          }
        ...
        test('Empty left must throw exception', () => {
          const testFx = () => {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            //@ts-ignore
            createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0},]});
          }
          expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].left is not a number');
        })
      })
      suite('Grid validators',()=>{
        test('If no grid set must throw exception',()=>{
          const testFx = () => {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            //@ts-ignore
            createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0},]});
          }
          expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid have no items. At least one is required.');
        })
        test('Wrong grid set must throw exception',()=>{
          const testFx = () => {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            //@ts-ignore
            createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:'a'},]});
          }
          expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid have no items. At least one is required.');
        })
        test('Empty grid set must throw exception',()=>{
          const testFx = () => {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            //@ts-ignore
            createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:[]},]});
          }
          expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid have no items. At least one is required.');
        })
        suite('Validate grid content',()=>{
          test('Test index in exception',()=>{
            ...
            expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid[1].fromCount is not a positive number');
          })
          suite('fromCount validators',()=>{
            test('fromCount === 0 must throw exception', () => {
              const testFx = () => {
                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                //@ts-ignore
                createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:[{fromCount:0}]},]});
              }
              expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid[0].fromCount is not a positive number');
            })
            test('fromCount < 0 must throw exception', () => {
              const testFx = () => {
                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                //@ts-ignore
                createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:[{fromCount:-1}]},]});
              }
              expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid[0].fromCount is not a positive number');
            })
            test('NaN fromCount must throw exception', () => {
              const testFx = () => {
                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                //@ts-ignore
                createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:[{fromCount:'a'}]},]});
              }
              expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid[0].fromCount is not a positive number');
            })
          })
          suite('toCount validators',()=>{
            test('toCount === 0 must throw exception', () => {
              const testFx = () => {
                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                //@ts-ignore
                createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:[{fromCount:1,toCount:0}]},]});
              }
              expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid[0].toCount is not a positive number');
            })
            test('toCount < 0 must throw exception', () => {
              const testFx = () => {
                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                //@ts-ignore
                createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:[{fromCount:1,toCount:-1}]},]});
              }
              expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid[0].toCount is not a positive number');
            })
            test('NaN toCount must throw exception', () => {
              const testFx = () => {
                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                //@ts-ignore
                createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:[{fromCount:1,toCount:'a'}]},]});
              }
              expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid[0].toCount is not a positive number');
            })
          })
          suite('colCount validators',()=>{
            test('colCount === 0 must throw exception', () => {
              const testFx = () => {
                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                //@ts-ignore
                createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:[{fromCount:1,toCount:1,colCount:0}]},]});
              }
              expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid[0].colCount is not a positive number');
            })
            test('colCount < 0 must throw exception', () => {
              const testFx = () => {
                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                //@ts-ignore
                createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:[{fromCount:1,toCount:1,colCount:-1}]},]});
              }
              expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid[0].colCount is not a positive number');
            })
            test('NaN colCount must throw exception', () => {
              const testFx = () => {
                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                //@ts-ignore
                createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:[{fromCount:1,toCount:1,colCount:'a'}]},]});
              }
              expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid[0].colCount is not a positive number');
            })
          })
          suite('rowCount validators',()=>{
            test('rowCount === 0 must throw exception', () => {
              const testFx = () => {
                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                //@ts-ignore
                createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:[{fromCount:1,toCount:1,colCount:1,rowCount:0}]},]});
              }
              expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid[0].rowCount is not a positive number');
            })
            test('rowCount < 0 must throw exception', () => {
              const testFx = () => {
                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            ...
            test('NaN rowCount must throw exception', () => {
              const testFx = () => {
                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                //@ts-ignore
                createTiler({width: 1920, height: 1080, areas: [{priority:0,width:1920,height:1080,top:0,left:0,grid:[{fromCount:1,toCount:1,colCount:1,rowCount:'a'}]},]});
              }
              expect(testFx).to.throw(TypeError, 'layoutOptions.area[0].grid[0].rowCount is not a positive number');
            })
          })
  ...
  suite('Ffmpeg format',()=>{
    ...
    suite('getTargetMiddleOffset',()=> {
      ...
      mockData.forEach(({source,target,expectation})=>{
        test(`Target ${target.w}x${target.h} source ${source.w}x${source.h} expect ${arrFormat(expectation)}`,()=>{
      ...
      test('X and y target position',()=>{
        const result = getTargetMiddleOffset({target:{...BIG_9_TO_16,x:702,y:404},source:SMALL_1_TO_2});
